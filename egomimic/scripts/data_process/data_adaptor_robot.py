...
class Adaptor:
    ...
    def rdt2ego(self, ego_data_path:str, action_chunk:int, rdt_data_path:str="/home/lvhuaihai/EgoMimic/datasets/cobot/data_pour3cups_cobot"):
...
if __name__ == "__main__":
    adaptor = Adaptor()
    action_chunk = 50
    adaptor.rdt2ego(f"/home/lvhuaihai/EgoMimic/datasets/cobot_pour3cups_100pairs_{action_chunk}steps_400frames.hdf5", action_chunk = action_chunk)
