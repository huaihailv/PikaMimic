...
def main(args):
    ...
    if args.name is not None and args.description is not None:
        ...
        possible_resume = os.path.join(base_output_dir, "../experiment_results", args.name, args.description, "models/last.ckpt")
...
if __name__ == "__main__":
    ...
    args.description = f"cobot_groceries_100pairs_50steps"
    main(args)
