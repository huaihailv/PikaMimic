...
@register_algo_factory_func("pikamimic")
def algo_config_to_class(algo_config):
    ...
    """
    algo_class, algo_kwargs = PikaMimic, {}
    return algo_class, algo_kwargs


class PikaModel(ACTModel):
    def __init__(
            self,
            backbones,
            transformer,
...
class PikaMimic(ACT):
    ...
    def _create_networks(self):
        super(PikaMimic, self)._create_networks()
    ...
    def _forward_training(self, batch):
        ...
        cam_keys = (
            self.camera_keys if modality == "robot" else self.camera_keys
